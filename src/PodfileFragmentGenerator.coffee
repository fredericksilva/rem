...
podfileFragmentAsync = co.wrap (dir='.') ->
  ...
  unless reactNativeApp
    throw new Error """
      Your package doesn't appear to be configured as a React Native app that uses rem
      Add a `reactNativeApp` key to your package.json.
      For more information see: https://github.com/ReactExtensionManager/rem/blob/master/README.md
      """
