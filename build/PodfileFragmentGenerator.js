...
podfileFragmentAsync = co.wrap(function*(dir) {
  var defaultPodspec, i, len, name, nativePackages, np, podspecPath, podspecs;
  if (dir == null) {
    dir = '.';
  }
  ...
  return "# Generated by rem for " + ((yield jsonAsync(path.join(dir, 'package.json')))).name + "\n" + (((function() {
    var j, len1, ref, results;
    results = [];
    for (j = 0, len1 = podspecs.length; j < len1; j++) {
      ref = podspecs[j], name = ref[0], podspecPath = ref[1];
